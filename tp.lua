return {
    descriptions = {
        ...
        Tarot = {
            ...
            c_devil = {
                ...
                text = {
                    "󱥄󱤭󱤧󱤆",
                    "󱤉󱤪{C:attention}#1#{}󱥩{C:attention}#2#"
                }
            },
            c_tower = {
                name = "󱤑󱥐",
            ...
            c_star = {
                ...
                text = {
                    "󱥄󱤭󱤧󱤆",
                    "󱤉󱤞󱤪{C:attention}#1#{}󱥩{V:1}#2#"
                }
            },
            c_moon = {
                name = "󱥤󱤆",
                text = {
                    "󱥄󱤭󱤧󱤆󱤉󱤞󱤪{C:attention}#1#{}",
                    "󱥩{V:1}#2#"
                }
            },
            c_sun = {
        ...
        Spectral = {
            ...
            c_deja_vu = {
                name = "󱤝󱥫",
                text = {
                    "󱥄󱤭󱥄󱥸󱤉󱤪󱤓{C:attention}1{}󱤙{C:red}󱤜󱤫{}",
                }
            },
            c_hex = {
                name = "󱤝󱥈",
                text = {
                    "󱥄󱥸󱤉{C:attention}󱤪󱤻{}1󱤙{C:dark_edition}󱥤󱤞{}󱦜",
                    "󱥄󱤷󱤉󱤪󱤻󱤆󱤄"
                }
            },
            c_trance = {
                name = "󱤝󱥡",
                text = {
                    "󱥄󱤭󱥄󱥸󱤉󱤪󱤓{C:attention}1{}󱤙{C:blue}󱤜󱤣{}",
                }
            },
            c_medium = {
                name = "󱤝󱤮",
                text = {
                    "󱥄󱤭󱥄󱥸󱤉󱤪󱤓{C:attention}1{}󱤙{C:purple}󱤜󱥏{}",
                }
            },
            c_cryptid = {
                name = "󱤝󱥢",
                text = {
                    "󱥄󱤭󱤉󱤪󱤓1󱦜",
                    "󱥄󱥉󱤉󱤪󱥿{C:attention}#1#{}󱥧󱥆"
                }
            },
            c_soul = {
                name = "󱤾󱤝",
                text = {
                    "󱥄󱥉󱤉󱤪󱤻{C:legendary,E:1}Legendary{}",
                    "{C:inactive}(󱥓󱤧󱤬󱤂󱤡󱥞󱥉󱤂)"
                }
            },
            c_black_hole = {
        ...
        Edition = {
            ...
            e_negative = {
                name = "󱥤󱥏",
                text = {
                    "{C:dark_edition}+󱥓󱥍󱤪󱤻#1#{}"
                }
            },
            e_negative_consumable = {
                name = "󱥤󱥏",
                text = {
                    "{C:dark_edition}+󱥓󱥍󱤪󱤙#1#{}"
                }
            }
        },
        Enhanced = {
        ...
        Other = {
            ...
            p_arcana_normal = {
                name = "󱤟󱥍󱤪󱤾",
                text = {
                    "󱥄󱤙󱤉{C:tarot}󱤪󱤾{C:attention}#1#{}󱥧󱤪{C:attention}#2#{}",
                }
            },
            p_arcana_jumbo = {
                name = "󱤟󱥣󱥍󱤪󱤾",
            ...
            p_celestial_normal = {
                name = "󱤟󱥍󱤪󱤺",
                text = {
                    "󱥄󱤙󱤉{C:planet}󱤪󱤺{C:attention}#1#{}󱥧󱤪{C:attention}#2#{}",
                }
            },
            p_celestial_jumbo = {
                name = "󱤟󱥣󱥍󱤪󱤺",
            ...
            p_spectral_normal = {
                name = "󱤟󱥍󱤪󱤝",
                text = {
                    "󱥄󱤙󱤉{C:spectral}󱤪󱤝{C:attention}#1#{}󱥧󱤪{C:attention}#2#{}",
                }
            },
            p_spectral_jumbo = {
                name = "󱤟󱥣󱥍󱤪󱤝",
            ...
            p_standard_normal = {
                name = "󱤟󱥍󱤪󱦂",
                text = {
                    "󱥄󱦅󱤉{C:attention}󱤪󱦂{C:attention}#1#{}󱥧󱤪{C:attention}#2#{}",
                }
            },
            p_standard_jumbo = {
                name = "󱤟󱥣󱥍󱤪󱦂",
            ...
            p_buffoon_normal = {
                name = "󱤟󱥍󱤪󱤻",
                text = {
                    "󱥄󱦅󱤉{C:joker}󱤪󱤻{C:attention}#1#{}󱥧󱤪{C:attention}#2#{}",
                }
            },
            p_buffoon_jumbo = {
                name = "󱤟󱥣󱥍󱤪󱤻",
    ...
    misc = {
        ...
        poker_hands = {
            ...
            ['Five of a Kind'] = "󱤭󱥍󱤽󱥖",
            ['Royal Flush'] = "󱤭󱤿󱤤",
            ['Straight Flush'] = "󱤭󱤿󱥍󱤞󱥖",
            ['Four of a Kind'] = "󱤭󱥍󱤪4󱥖",
            ['Full House'] = "󱤭󱥭",
            ['Flush'] = "󱤭󱥍󱤞󱥖",
            ['Straight'] = "󱤭󱤿",
            ['Three of a Kind'] = "󱤭󱥍󱤪3󱥖",
            ['Two Pair'] = "󱤭2󱥍󱤪2󱥖",
            ['Pair'] = "󱤭󱥍2󱥖",
            ['High Card'] = "󱤭󱤍"
        },
        ...
        dictionary = {
            ...
            k_lower_score = "󱥍󱥱󱥁",
            k_arcana_pack = "󱤟󱥍󱤪󱤾",
            k_celestial_pack = "󱤟󱥍󱤪󱤺",
            k_spectral_pack = "󱤟󱥍󱤪󱤝",
            k_standard_pack = "󱤟󱥍󱤪󱦂",
            k_buffoon_pack = "󱤟󱥍󱤪󱤻",
            k_enter_text = "󱥄󱥠",
            ...
            ph_choose_blind_1 = "󱥄󱥩",
            ph_choose_blind_2 = "󱥽󱥒󱥞",
            ph_mr_bones = "Saved by Mr. Bones",
            ph_score_at_least = "Score at least",
            ph_all_poker_hand = "󱤭󱤄",
            ph_1_level = "+1 Level",
            ph_boss_disabled = "󱥽󱤧󱤘󱤂!",
